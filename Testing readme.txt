...
Word File----------Content.doc 
Image File---------WP_20141106_003.png
Audio File--------- NeverBackDown.mp3
DLL File-----------Example.dll
Executable File ----------Sample.exe
...
4. Go To MP-Project/Files and verify that *.doc.lzw file is created.
...
4. Go To MP-Project/Files and verify that *New.doc file is created. 
